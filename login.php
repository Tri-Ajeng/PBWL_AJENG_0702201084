...
<body id="bg-login" style="display: flex; height: 100vh; justify-content: center;
    align-items: center; background-color: #c5b20b">
    <div class="box-login" style="width: 300px; min-height: 200px; 
    border: 1px solid black; background-color: white; padding: 15px;">
        <h2>LOGIN</h2>
        <form action="" method="POST">
            ...
            <input type="submit" name="login" value="Login" class="button-login" style="padding: 8px 15px;background-color: #c5b20b; color: white; 
            font-size: 15px;">
        </form>
    <?php
